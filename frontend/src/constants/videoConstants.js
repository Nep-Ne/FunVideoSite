...
export const VIDEO_COMMENT_SAVE_REQUEST = 'VIDEO_COMMENT_SAVE_REQUEST';
export const VIDEO_COMMENT_SAVE_SUCCESS = 'VIDEO_COMMENT_SAVE_SUCCESS';
export const VIDEO_COMMENT_SAVE_FAIL = 'VIDEO_COMMENT_SAVE_FAIL';
export const VIDEO_COMMENT_SAVE_RESET = 'VIDEO_COMMENT_SAVE_RESET';
