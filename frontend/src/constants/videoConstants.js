...
export const VIDEO_REVIEW_SAVE_REQUEST = 'VIDEO_REVIEW_SAVE_REQUEST';
export const VIDEO_REVIEW_SAVE_SUCCESS = 'VIDEO_REVIEW_SAVE_SUCCESS';
export const VIDEO_REVIEW_SAVE_FAIL = 'VIDEO_REVIEW_SAVE_FAIL';
export const VIDEO_REVIEW_SAVE_RESET = 'VIDEO_REVIEW_SAVE_RESET';
